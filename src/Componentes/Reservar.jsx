...
function Reservar() {
  ...
  // Estado para controlar el panel de filtros móvil
  ...
  // Funciones para controlar el panel de filtros móvil
  ...
  // Aplicar los filtros y cerrar el panel móvil
        ...
        <div className="container">
          {loading ? (
            ...
            <div className="vehicle-content">
              ...
              <div className={`mobile-filters-container ${mobileFiltersVisible ? 'active' : ''}`}>
                <div className="mobile-filters-panel">
                  <div className="mobile-filters-header">
                    <h3 className="mobile-filters-title">Filtrar vehículos</h3>
                    <button className="mobile-filters-close" onClick={closeMobileFilters}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div className="mobile-filters-actions">
                    <button className="mobile-filters-clear" onClick={clearAllFilters}>
                      Limpiar filtros
                    </button>
                    <button className="mobile-filters-apply" onClick={applyMobileFilters}>
                      Aplicar filtros
                    </button>
                  </div>
                </div>
              ...
              {/* Versión escritorio del sidebar */}
              <Sidebar
                selectedType={filters.type}
                selectedCapacity={filters.capacity}
                priceRange={filters.priceRange}
